...
<div class="p-6">
        ...
        <Table.Root>
            ...
            <Table.Body>
                {#if beneficiaries.length === 0}
                    <Table.Row>
                        <Table.Cell colspan={2} class="text-center h-24 text-muted-foreground">
                    ...
                    {#each beneficiaries as b}
                        <Table.Row>
                            ...
                            <Table.Cell class="text-right">
                                <Button variant="ghost" size="icon" onclick={() => openEdit(b.Name)}>
    ...
    <Dialog.Root bind:open={isDialogOpen}>
        <Dialog.Content>
            <Dialog.Header>
                <Dialog.Title>{isEditing ? 'Edit' : 'Add'} Beneficiary</Dialog.Title>
            </Dialog.Header>
